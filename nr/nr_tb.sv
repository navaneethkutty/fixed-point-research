...
module tb_reciprocal_nr_q16_16;
    ...
    initial begin
        $display("==============================================================");
        $display(" Q16.16 CANONICAL 1,000,001-POINT TEST");
        $display("==============================================================");
        ...
        $readmemh("q16_16_expected.mem", expected_mem);

        $display("Memory loading complete.");
        $display("==============================================================");

        csv_fd = $fopen("q16_16_nr_results.csv", "w");

        if (csv_fd == 0) begin
            $fatal(1, "ERROR: Could not create q16_16_nr_results.csv");
        end

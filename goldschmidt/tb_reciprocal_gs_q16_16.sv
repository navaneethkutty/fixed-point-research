...
module tb_reciprocal_gs_q16_16;
    ...
    initial begin
        $display("==============================================================");
        $display(" Q16.16 GOLDSCHMIDT 1,000,001-POINT TEST");
        $display("==============================================================");
        $display(
            "Warm-up samples excluded from statistics: %0d",
            WARMUP_SAMPLES
        );

        $display("Loading q16_16_input.mem...");
        ...
        $display("Loading q16_16_expected.mem...");
        ...
        if (csv_fd == 0) begin
            $fatal(
                1,
                "ERROR: Could not create q16_16_gs_results.csv"
            );
        end
    ...
    initial begin
        ...
        $display(
            " FINAL 1,000,001-POINT RESULTS (GOLDSCHMIDT)"
        );
        $display(
            "=============================================================="
        );
